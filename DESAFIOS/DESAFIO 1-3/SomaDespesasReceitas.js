...
//         receitas = usuarios[i].receitas
//         despesas = usuarios[i].despesas
...
// console.log(calculaSaldo(usuarios,usuarios));
...
for (let usuario of usuarios) {
    ...
    if (saldoUsuario >= 0) {
        console.log(`${usuario.nome} possui saldo POSITIVO de ${saldoUsuario}`)
    } else {
        console.log(`${usuario.nome} possui saldo NEGATIVO de ${saldoUsuario}`)
    }
}